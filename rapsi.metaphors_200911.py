...
#sys.path.append('../cgenomics/orthology.phylomedb.org/wsgi/')
...
#change params
url = "orthology.phylomedb.org"
rapsiurl = "/wsgi/metaPhOrs_query.py/similaritySearch_new?fasta="
blasturl = "/wsgi/metaPhOrs_query.py/similaritySearch?species=ALL&fasta="
